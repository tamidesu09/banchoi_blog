...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="card">
            <div class="card-body">
                <h2 class="card-head mb-2 text-black">Register Now!</h2>
                ...
                <div class="input-icon mb-3 mt-3">
                    ...
                    <input type="text" value="" class="form-control" placeholder="Input your username here" />
                </div>
                ...
                <div class="already-message mt-3">
                    <h3 class="text-black">Already have an account? <a href="<?php echo base_url('auth/login'); ?>"
                            class="text-primary">Log In</a></h3>
                </div>
            </div>
        </div>
    </div>
